      ...
      <section className="border-y border-line">
        <div className="mx-auto max-w-[1280px] px-6 py-20 grid md:grid-cols-2 gap-x-12 gap-y-10">
          <Pitch
            ...
            body="The fund connects you to a contribution stream. The allocation engine ranks Dutch food banks by FRAME-computed CO₂e baseline or social reach — and weights your contribution accordingly. An ESRS E5 + S3 contribution disclosure is generated with full FRAME workings, source citations, and provenance ledger."
            href="/marketplace"
            cta="Browse funds →"
          />
          <Pitch
            ...
            body="Drop your annual report PDF. Kavel extracts food volumes, categories, and people served — every measurement tagged with extracted, inferred, or computed. FRAME does the rest. Once your data is in, you appear in the marketplace and corporates can sponsor your operations."
            href="/for-foodbanks"
        ...
        <div className="mx-auto max-w-[1280px] px-6 py-20 grid lg:grid-cols-[1fr_1.4fr] gap-x-12 gap-y-10 items-start">
          <div>
            ...
            <p className="text-text-muted text-[14.5px] mt-5 max-w-[44ch] leading-relaxed">
              ...
              contribution disclosure — streamed live, every
          ...
          <figure className="border border-line bg-surface rounded-[var(--radius-lg)] overflow-hidden">
            ...
            <div className="px-7 py-8 md:px-10 md:py-10 max-w-[58ch] mx-auto">
              ...
              <div className="mt-7 pt-5 border-t border-line flex items-center gap-4 text-[11px] tabular text-text-faint">
                <span>Generated · 2026-04-22 14:18 CET</span>
