...
export const metadata = {
  title: "For food banks · Klimaatkracht",
  description:
...
const PIPELINE = [
  ...
  },
  {
    ...
    body: "Once you appear in the marketplace, corporates buying a Klimaatkracht package allocate a verified climate contribution share to your operation. Quarterly. Auditable. Disclosed under ESRS E5 + S3, never offset.",
  },
] as const
        ...
        <header className="mx-auto max-w-[1280px] px-6 pt-12 md:pt-20 pb-16 md:pb-20 grid md:grid-cols-[1.4fr_1fr] gap-12 items-end">
          <div>
            ...
            <p className="mt-6 text-text-muted text-[15.5px] leading-relaxed max-w-[58ch]">
              Klimaatkracht turns the operational data already in your annual
      ...
      <section className="border-b border-line bg-emerald-soft/40">
        <div className="mx-auto max-w-[1280px] px-6 py-20 flex flex-col items-start gap-6">
          ...
          <p className="mt-2 text-[12px] text-text-faint italic">
            Free. No credit card. No lock-in. Klimaatkracht earns from the
