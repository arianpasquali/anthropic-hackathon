# Klimaatkracht API Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Build the full Klimaatkracht web app — corporate marketplace where companies buy Climate-Action Packages, a dynamic allocation engine distributes funds across Dutch food banks, and Claude generates CSRD-aligned impact reports delivered via SSE streaming.
...
<head>
  ...
  <title>{% block title %}Klimaatkracht{% endblock %}</title>
...
<body class="bg-gray-50 text-gray-900 min-h-screen">
  <nav class="bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between">
    <a href="/" class="text-xl font-bold text-green-700">🌱 Klimaatkracht</a>
...
```css
/* Klimaatkracht — minimal overrides on top of Tailwind */
...
```html
{% extends "base.html" %}
{% block title %}Login — Klimaatkracht{% endblock %}
{% block content %}
...
```html
{% extends "base.html" %}
{% block title %}Register — Klimaatkracht{% endblock %}
{% block content %}
<div class="max-w-md mx-auto mt-16">
...
def test_packages_page_returns_200(client: TestClient):
    ...
    assert b"Klimaatkracht" in resp.content
...
```html
{% extends "base.html" %}
{% block title %}Climate-Action Packages — Klimaatkracht{% endblock %}
{% block content %}
<div class="mb-8">
...
```html
{% extends "base.html" %}
{% block title %}{{ package.name }} — Klimaatkracht{% endblock %}
{% block content %}
<div class="max-w-2xl">
...
```html
{% extends "base.html" %}
{% block title %}Confirm purchase — Klimaatkracht{% endblock %}
{% block content %}
<div class="max-w-xl">
...
```html
{% extends "base.html" %}
{% block title %}Thank you — Klimaatkracht{% endblock %}
{% block content %}
...
```html
{% extends "base.html" %}
{% block title %}Dashboard — Klimaatkracht{% endblock %}
{% block content %}
...
```html
{% extends "base.html" %}
{% block title %}Impact Detail — Klimaatkracht{% endblock %}
{% block content %}
...
```bash
git add -A
git commit -m "feat: full Klimaatkracht MVP — marketplace, checkout, dashboard, Claude CSRD reports"
```
