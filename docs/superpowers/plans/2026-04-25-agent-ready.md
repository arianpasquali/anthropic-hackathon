...
**Goal:** Make Klimaatkracht discoverable and usable by AI agents per isitagentready.com criteria — llms.txt, robots.txt, sitemap, ai-plugin manifest, agent.json, Link headers, OpenAPI improvements, and markdown content negotiation.
...
Expected outputs:
- `llms.txt`: starts with `# Klimaatkracht`
